	...
	let root = [
		{
			files: [
				{ name: "config.json" },
				{
					files: [{ name: "main.css" }, { name: "style.min.css" }],
					name: "css",
				},
				{
					files: [
				...
				{
					files: [{ name: "jstree.min.js" }, { name: "main.js" }],
					name: "js",
				},
			],
			name: "static",
		...
		{ name: "LICENSE" },
		{ name: ".gitignore" },
		{ files: [{ name: "base.py" }, { name: "routes.py" }], name: "src" },
		{
			files: [{ name: "main.py" }, { name: "test_install.py" }],
			name: "test",
		},
		{ name: "README.md" },
		{ name: "main.py" },
		{ files: [{ name: "main.html" }], name: "templates" },
	];
</script>
